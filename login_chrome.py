...
class Login(unittest.TestCase):
    ...
    def test_login(self):
        ...
        self.autorization("", "")
        WebDriverWait(self.driver, self.delay).until(EC.visibility_of_element_located((By.XPATH, "//span[contains(text(), 'Enter email address')]")))
        WebDriverWait(self.driver, self.delay).until(EC.visibility_of_element_located((By.XPATH, "//span[contains(text(), 'Enter password')]")))
        ...
        WebDriverWait(self.driver, self.delay).until(
            EC.visibility_of_element_located((By.XPATH, "//span[contains(text(), 'Enter password')]")))
        self.assertTrue(self.driver.page_source.__contains__(self.enter_password))
        print("- Выдается сообщение: ", self.enter_password)
        ...
        WebDriverWait(self.driver, self.delay).until(
            EC.visibility_of_element_located((By.XPATH, "//span[contains(text(), 'The username or password you entered is incorrect. ')]")))
        ...
        WebDriverWait(self.driver, self.delay).until(
            EC.visibility_of_element_located((By.XPATH, "//span[contains(text(), 'Email is not a valid email address.')]")))
