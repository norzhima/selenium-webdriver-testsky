...
# import lk_methods
from lk_methods_for_cls import MethodsFroCls

class LkBase(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        #cls.find = lk_find.Find(cls.driver)
        cls.driver.get(lk_priv_data.main_url)
        cls.methods = MethodsFroCls(cls.driver)
        cls.methods.change_language()
        cls.methods.debug_panel()

    def setUp(self):
        # self.change_language_and_debug_panel()
    ...
    # def change_language_and_debug_panel(self):
